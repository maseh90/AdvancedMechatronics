...
void LCD_incrementBar(unsigned short, unsigned short, unsigned short, unsigned int);

// drawChar function
void LCD_drawChar(unsigned short, unsigned short, unsigned short, unsigned char); // draws ONE singular character on LCD

// drawString function
void LCD_drawString(unsigned short, unsigned short, unsigned short, unsigned char *);

void Gyroscope_Printer_x(signed short);

void Gyroscope_Printer_y(signed short);
#endif